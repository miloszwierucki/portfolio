...
export default function ControllerClient(props: {
  ...
  return (
    <nav className="bg-surface ring-border rounded-navigation shadow-panel font-label fixed inset-x-0 bottom-3 z-20 mx-auto flex max-w-fit flex-col items-center justify-center gap-1 px-4 py-2 text-sm ring-1 backdrop-blur-md md:flex-row xl:bottom-5 xl:text-base">
