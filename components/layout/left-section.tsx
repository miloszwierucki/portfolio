  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center gap-4 md:gap-2 lg:gap-4">
        ...
        <h1
          className="text-center font-jakarta text-3xl font-semibold md:text-xl lg:text-xl xl:text-3xl"
      ...
      <div className="my-6 h-[1.5px] w-full bg-cod-gray-200/40 md:my-4 lg:my-6 dark:bg-cod-gray-200/15"></div>

      {data.sidebar.blocks && (
        <div className="flex flex-1 overflow-y-scroll scrollbar-none">
          <div className="flex w-full flex-col gap-2 md:items-center lg:items-start xl:gap-3">
            {data.sidebar.blocks.map(
              (block) =>
                block && (
                  ...
                  >
                    <div className="flex w-full items-center gap-2 text-nowrap rounded-md px-4 py-2 text-base duration-300 hover:shadow-md md:w-fit md:text-sm lg:w-full lg:px-1 xl:gap-4 xl:px-4 xl:text-lg">
                      <div
                        className="grid size-10 shrink-0 grow-0 place-content-center rounded-lg bg-cod-gray-200/10 xl:size-12 dark:bg-cod-gray-200/5"
                        data-tina-field={tinaField(block, "icon")}
                      >
                        <Icon name={block.icon as keyof typeof Icon} />
                      </div>
                      <div
                        className="flex flex-col md:hidden lg:flex xl:ml-2"
                        data-tina-field={tinaField(block, "text")}
                      >
                        <span
                          className="text-xs text-neutral-500 md:text-sm lg:text-xs xl:text-sm"
