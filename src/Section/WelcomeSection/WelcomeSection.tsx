...
export const WelcomeSection = () => (
  <section className="px-5 md:px-12 xl:px-28">
    <div className="min-h-[31rem] mt-24 sm:min-h-0 sm:w-[48rem] md:w-[54rem] md:mt-36 lg:w-[70rem] xl:w-[80rem] xl:mt-48">
      <h1 className="text-[1.75rem] font-semibold flex items-center lg:text-[2rem] xl:text-[2.5rem]">
        <img
          src={hello}
      ...
      <div className="font-medium w-1/2 min-w-[11rem] mt-8 xl:mt-4">
        <p className="text-[1.125rem] leading-[1.5rem] sm:text-xl lg:text-2xl xl:text-3xl">
          I’m a young hobbyist born in Poland. I write websites and construct 3D
          visualizations.
        </p>
        <p className="text-[0.95rem] mt-2 sm:text-base lg:text-lg xl:text-2xl">
    ...
    <div className="right-[-1.5rem] top-48 absolute sm:right-0 sm:top-40 md:top-28 lg:right-16 lg:top-30 xl:right-[6.5rem] xl:top-44 cover">
      <img
        src={photo}
        alt="Milosz Wierucki's photo"
        className="w-52 sm:w-64 md:w-80 lg:w-[22rem] xl:w-[26rem]"
      />
    </div>
  </section>
);
